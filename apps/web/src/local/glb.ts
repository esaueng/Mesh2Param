...
export function meshToGlb(mesh: BrowserMesh): Blob {
  ...
  const binaryLength = align4(indexOffset + mesh.indices.byteLength);
  ...
  const document = {
    ...
    materials: [{ name: "Reconstructed", pbrMetallicRoughness: { baseColorFactor: [0.2, 0.58, 0.95, 1], metallicFactor: 0.1, roughnessFactor: 0.42 } }],
