"""Generate the deterministic G-series general-parametric fixture corpus."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="fixture root (default: samples/general-parametric-benchmark)",
    )
    parser.add_argument(
        "--fixture",
        action="append",
        choices=tuple(GENERAL_FIXTURES_BY_SLUG),
        dest="fixtures",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    generated = generate_general_fixture_corpus(args.output, args.fixtures)
