...
const schema100 = {"oneOf":[{"$ref":"#/$defs/extrusionFeature"},{"$ref":"#/$defs/pocketFeature"},{"$ref":"#/$defs/holeFeature"},{"$ref":"#/$defs/counterboreFeature"},{"$ref":"#/$defs/countersinkFeature"},{"$ref":"#/$defs/revolutionFeature"},{"$ref":"#/$defs/linearPatternFeature"},{"$ref":"#/$defs/circularPatternFeature"},{"$ref":"#/$defs/mirrorFeature"},{"$ref":"#/$defs/chamferFeature"},{"$ref":"#/$defs/filletFeature"},{"$ref":"#/$defs/importedFacetedFeature"},{"$ref":"#/$defs/reconstructedSurfaceNetworkFeature"}]};
...
const err11 = {instancePath:instancePath+"/kind",schemaPath:"#/properties/kind/enum",keyword:"enum",params:{allowedValues: schema149.properties.kind.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err11];
}
else {
...
const err25 = {instancePath:instancePath+"/status",schemaPath:"#/properties/status/enum",keyword:"enum",params:{allowedValues: schema149.properties.status.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/kernelReference",schemaPath:"#/properties/kernelReference/type",keyword:"type",params:{type: schema149.properties.kernelReference.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const schema154 = {"type":"object","additionalProperties":false,"required":["id","sourceType","sourceIds","confidence"],"properties":{"id":{"$ref":"#/$defs/identifier"},"sourceType":{"enum":["meshPatch","meshTriangle","sketchEntity","feature","user","engine","imported","derived"]},"sourceIds":{"type":"array","items":{"$ref":"#/$defs/identifier"},"uniqueItems":true},"measuredValue":{"type":["number","null"]},"suggestedNominalValue":{"type":["number","null"]},"residual":{"type":["number","null"],"minimum":0},"confidence":{"$ref":"#/$defs/confidence"},"notes":{"type":["string","null"],"maxLength":2000},"metadata":{"type":["object","null"],"additionalProperties":{"$ref":"#/$defs/jsonValue"}}}};
...
for(const key0 in data){
if(!(func1.call(schema154.properties, key0))){
const err4 = {instancePath,schemaPath:"#/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key0},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err4];
}
...
const err9 = {instancePath:instancePath+"/sourceType",schemaPath:"#/properties/sourceType/enum",keyword:"enum",params:{allowedValues: schema154.properties.sourceType.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
if((!((typeof data4 == "number") && (isFinite(data4)))) && (data4 !== null)){
const err16 = {instancePath:instancePath+"/measuredValue",schemaPath:"#/properties/measuredValue/type",keyword:"type",params:{type: schema154.properties.measuredValue.type},message:"must be number,null"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
if((!((typeof data5 == "number") && (isFinite(data5)))) && (data5 !== null)){
const err17 = {instancePath:instancePath+"/suggestedNominalValue",schemaPath:"#/properties/suggestedNominalValue/type",keyword:"type",params:{type: schema154.properties.suggestedNominalValue.type},message:"must be number,null"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
if((!((typeof data6 == "number") && (isFinite(data6)))) && (data6 !== null)){
const err18 = {instancePath:instancePath+"/residual",schemaPath:"#/properties/residual/type",keyword:"type",params:{type: schema154.properties.residual.type},message:"must be number,null"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
if((typeof data8 !== "string") && (data8 !== null)){
const err23 = {instancePath:instancePath+"/notes",schemaPath:"#/properties/notes/type",keyword:"type",params:{type: schema154.properties.notes.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
const err25 = {instancePath:instancePath+"/metadata",schemaPath:"#/properties/metadata/type",keyword:"type",params:{type: schema154.properties.metadata.type},message:"must be object,null"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const schema158 = {"type":"object","additionalProperties":false,"required":["maxFeatures","beamWidth","candidatesPerResidual","wallClockSeconds","maxRebuilds","minScoreImprovement","nominalSnappingEnabled","nominalSnapTolerance","scoreWeights"],"properties":{"maxFeatures":{"type":"integer","minimum":1},"beamWidth":{"type":"integer","minimum":1},"candidatesPerResidual":{"type":"integer","minimum":1},"wallClockSeconds":{"type":"number","exclusiveMinimum":0},"maxRebuilds":{"type":"integer","minimum":1},"minScoreImprovement":{"type":"number","minimum":0},"nominalSnappingEnabled":{"type":"boolean"},"nominalSnapTolerance":{"type":"number","minimum":0},"scoreWeights":{"$ref":"#/$defs/scoreWeights"}}};
const schema159 = {"type":"object","additionalProperties":false,"required":["rmsDistance","p95Distance","maxDistance","normalAgreement","volumeDifference","overlap","sharpEdgeAlignment","boundaryAlignment","unmatchedSource","excessResult","complexity","unsupportedOperation","evidenceConfidence"],"properties":{"rmsDistance":{"type":"number","minimum":0},"p95Distance":{"type":"number","minimum":0},"maxDistance":{"type":"number","minimum":0},"normalAgreement":{"type":"number","minimum":0},"volumeDifference":{"type":"number","minimum":0},"overlap":{"type":"number","minimum":0},"sharpEdgeAlignment":{"type":"number","minimum":0},"boundaryAlignment":{"type":"number","minimum":0},"unmatchedSource":{"type":"number","minimum":0},"excessResult":{"type":"number","minimum":0},"complexity":{"type":"number","minimum":0},"unsupportedOperation":{"type":"number","minimum":0},"evidenceConfidence":{"type":"number","minimum":0}}};
...
if(!(func1.call(schema159.properties, key1))){
...
const schema162 = {"type":"object","additionalProperties":false,"required":["status","brepValid","stepReimportValid","toleranceSatisfied","issues"],"properties":{"status":{"enum":["notRun","pending","valid","invalid","partial"]},"brepValid":{"type":["boolean","null"]},"stepReimportValid":{"type":["boolean","null"]},"toleranceSatisfied":{"type":["boolean","null"]},"checkedAt":{"$ref":"#/$defs/nullableTimestamp"},"lastValidFeatureId":{"$ref":"#/$defs/nullableIdentifier"},"issues":{"type":"array","items":{"$ref":"#/$defs/validationIssue"}}}};
const schema164 = {"type":"object","additionalProperties":false,"required":["code","message","severity"],"properties":{"code":{"type":"string","minLength":1},"message":{"type":"string","minLength":1},"severity":{"enum":["info","warning","error"]},"featureId":{"$ref":"#/$defs/nullableIdentifier"},"semanticReference":{"$ref":"#/$defs/nullableIdentifier"},"details":{"type":["object","null"],"additionalProperties":{"$ref":"#/$defs/jsonValue"}}}};
...
const err8 = {instancePath:instancePath+"/severity",schemaPath:"#/properties/severity/enum",keyword:"enum",params:{allowedValues: schema164.properties.severity.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const err9 = {instancePath:instancePath+"/details",schemaPath:"#/properties/details/type",keyword:"type",params:{type: schema164.properties.details.type},message:"must be object,null"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
const err6 = {instancePath:instancePath+"/status",schemaPath:"#/properties/status/enum",keyword:"enum",params:{allowedValues: schema162.properties.status.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const err7 = {instancePath:instancePath+"/brepValid",schemaPath:"#/properties/brepValid/type",keyword:"type",params:{type: schema162.properties.brepValid.type},message:"must be boolean,null"};
if(vErrors === null){
vErrors = [err7];
}
else {
...
const err8 = {instancePath:instancePath+"/stepReimportValid",schemaPath:"#/properties/stepReimportValid/type",keyword:"type",params:{type: schema162.properties.stepReimportValid.type},message:"must be boolean,null"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const err9 = {instancePath:instancePath+"/toleranceSatisfied",schemaPath:"#/properties/toleranceSatisfied/type",keyword:"type",params:{type: schema162.properties.toleranceSatisfied.type},message:"must be boolean,null"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
for(let i0=0; i0<len0; i0++){
if(!(validate136(data6[i0], {instancePath:instancePath+"/issues/" + i0,parentData:data6,parentDataProperty:i0,rootData,dynamicAnchors}))){
...
const schema165 = {"type":"object","additionalProperties":false,"required":["versionId","createdAt","createdBy","message"],"properties":{"versionId":{"$ref":"#/$defs/identifier"},"parentVersionId":{"$ref":"#/$defs/nullableIdentifier"},"createdAt":{"type":"string","format":"date-time"},"createdBy":{"type":"string","minLength":1,"maxLength":200},"message":{"type":"string","maxLength":1000}}};
...
for(let i2=0; i2<len2; i2++){
if(!(validate125(data14[i2], {instancePath:instancePath+"/semanticTopology/" + i2,parentData:data14,parentDataProperty:i2,rootData,dynamicAnchors}))){
...
for(let i3=0; i3<len3; i3++){
if(!(validate127(data16[i3], {instancePath:instancePath+"/sourceEvidence/" + i3,parentData:data16,parentDataProperty:i3,rootData,dynamicAnchors}))){
...
if(data.reconstructionSettings !== undefined){
if(!(validate132(data.reconstructionSettings, {instancePath:instancePath+"/reconstructionSettings",parentData:data,parentDataProperty:"reconstructionSettings",rootData,dynamicAnchors}))){
...
if(!(func1.call(schema161.properties, key4))){
...
if(data.validation !== undefined){
if(!(validate134(data.validation, {instancePath:instancePath+"/validation",parentData:data,parentDataProperty:"validation",rootData,dynamicAnchors}))){
vErrors = vErrors === null ? validate134.errors : vErrors.concat(validate134.errors);
errors = vErrors.length;
}
}
if(data.versionMetadata !== undefined){
if(!(validate142(data.versionMetadata, {instancePath:instancePath+"/versionMetadata",parentData:data,parentDataProperty:"versionMetadata",rootData,dynamicAnchors}))){
